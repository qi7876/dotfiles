...
C4Context
    ...
    System_Ext(github, "GitHub", "Hosts the remote repository and pull requests")
    ...
    Rel(git, github, "Pushes and fetches commits")
    Rel(owner, github, "Reviews and merges changes")
